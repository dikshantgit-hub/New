...
public class main
{
    public static void main(String[] args)
    {
        ...
        BusCompany b1= new BusCompany("Pa11", "Red", "KTM-PKR", "Dikshant", true, 1000);
        BusCompany b2= new BusCompany("pa12", "Green", "KTM-BKR", "Ramesh", true, 100);
        BusCompany b3= new BusCompany("pa13", "Blue", "BKR-LTR", "Mahesh", false, 400);
